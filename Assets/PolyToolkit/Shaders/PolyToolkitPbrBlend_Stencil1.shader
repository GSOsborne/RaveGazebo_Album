...
Shader "Poly/PbrBlendDoubleSided_Stencil1" {
  Properties {
    ...
    //Experimentation adding emission
  ...
  SubShader {
    ...
    void surf (Input IN, inout SurfaceOutputStandard o) {
      ...
      //experimenting with Emission
           o.Emission = c.rgb * tex2D(_BaseColorTex, IN.uv_BaseColorTex).a * _EmissionColor;
